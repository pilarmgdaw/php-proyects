...
//Accedo a las funciones o métodos get() para recuperar la información del coche 1
//(opción 1)
echo "<strong>".$coche1->getPropietario()."</strong> se ha comprado un
...
//Accedo directamente a los atributos para recuperar la información del coche 2
//(opción 2)
echo "
