...
<strong><?php echo ($coche->puedeAparcar("superficie")) ? "si" : "no" ?>
></strong>
</div>
<div>
¿Puedo aparcar el coche en el subterráneo 2?:
<strong><?php echo ($coche->puedeAparcar("subterraneo2")) ? "si" : "no" ?>
></strong>
</div>
<div>
¿Puedo aparcar la furgoneta en la superficie?:
<strong><?php echo ($furgoneta->puedeAparcar("superficie")) ? "si" : "no" ?>
></strong>
</div>
<div>
¿Puedo aparcar la furgoneta el subterráneo 2?:
<strong><?php echo ($furgoneta->puedeAparcar("subterraneo2")) ? "si" : "no" ?>
></strong>
</div>
<div>
¿Puedo aparcar el autobús en la superficie?:
<strong><?php echo ($autobus->puedeAparcar("superficie")) ? "si" : "no" ?>
></strong>
</div>
<div>
¿Puedo aparcar el autobús el subterráneo 1?:
<strong><?php echo ($autobus->puedeAparcar("subterraneo1")) ? "si" : "no" ?>
></strong>
</div>
<div>
